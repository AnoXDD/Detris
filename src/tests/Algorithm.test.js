...
describe("Test applyDetrominoBlocks (original only)", () => {
  ...
  describe("Detromino surrounded by blocks", () => {
    test(`Flat I in between`, () => {
      const before = toMatrix(
        `  0000000000\n`
        + `0000000000\n`
        + `0000000000\n`
    ...
    test(`Vertical I in between and hit the floor`, () => {
      const before = toMatrix(
        `  0000000000\n`
        + `0000000000\n`
        + `0000000000\n`
